...
Object(_modules_loader__WEBPACK_IMPORTED_MODULE_3__["closeLoader"])();
...
/*!******************************!*\
  !*** ./js/modules/loader.js ***!
  \******************************/
/*! exports provided: closeLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeLoader", function() { return closeLoader; });
var ENTER_CODE = 13;
...
var closeLoader = function closeLoader() {
  document.addEventListener('DOMContentLoaded', function () {
    var closeLoaderFunction = function closeLoaderFunction() {
      var loaderBlock = document.querySelector('.loader');

      if (window.matchMedia("(max-width: ".concat(MAX_TABLET_WIDTH, "px)")).matches) {
        loaderBlock.addEventListener('click', function () {
...
var audience = document.querySelector('.main-content__audience');

var showAudience = function showAudience() {
  if (window.matchMedia("(max-width: ".concat(MAX_TABLET_WIDTH, "px)")).matches) {
    audience.classList.add('appirance-audience-block-tablet--back');
    mainBlock.addEventListener('click', function (evt) {
